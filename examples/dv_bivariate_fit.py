...
merged_data = pd.read_csv(
    "C:/Users/OEK-admin/OneDrive/Arbeit_Uni/Uni_Due/ProjectII/merged_data_1.csv"
)
...
sim_data_folder = (
    "C:/Users/OEK-admin/OneDrive/Arbeit_Uni/Uni_Due/ProjectII/simulations/"
)
...
for sim_file in sim_files[:250]:
    ...
    H = 2
    equation = {0: {h: np.arange(X_numpy.shape[1]) for h in range(H)}}

    distribution = BivariateCopulaNormal(
        link=FisherZLink(), param_link=KendallsTauToParameter()
    )
...
combined_df.to_csv(
    "C:/Users/OEK-admin/OneDrive/Arbeit_Uni/Uni_Due/ProjectII/combined_data.csv",
    index=False,
)

H = 2
equation = {0: {h: np.arange(X_numpy["Copula"].shape[1]) for h in range(H)}}
...
merged_data = pd.read_csv(
    "C:/Users/OEK-admin/OneDrive/Arbeit_Uni/Uni_Due/ProjectII/sim_data_26052025.csv"
)
...
# Save as pickle file
res_df_MC.to_pickle(
    "C:/Users/OEK-admin/OneDrive/Arbeit_Uni/Uni_Due/ProjectII/sim_data_26052025.pkl"
)
