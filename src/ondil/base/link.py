...
class LinkFunction(ABC):
    r"""The base class for the link functions."""
    ...
    def link(self, x: np.ndarray) -> np.ndarray:
        r"""Calculate the Link"""

    @abstractmethod
    def inverse(self, x: np.ndarray) -> np.ndarray:
        r"""Calculate the inverse of the link function"""

    @abstractmethod
    def link_derivative(self, x: np.ndarray) -> np.ndarray:
        r"""Calculate the first derivative of the link function"""
    ...
    def link_second_derivative(self, x: np.ndarray) -> np.ndarray:
        r"""Calculate the second derivative for the link function"""
        raise NotImplementedError("Currently not implemented.")

    @abstractmethod
    def inverse_derivative(self, x: np.ndarray) -> np.ndarray:
        r"""Calculate the first derivative for the inverse link function"""
        raise NotImplementedError("Currently not implemented.")
